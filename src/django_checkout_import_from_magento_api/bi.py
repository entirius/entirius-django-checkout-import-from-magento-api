...
BI_SOURCE = "django-checkout-import-from-magento-api"
...
class DCheckoutImportFromMagentoApiImportOrderStatusEvent(EventAbstract):
    details_type = "DCheckout Import From Magento Api - Import Order Status"
    version = 1
